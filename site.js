    ...
    <section id="bio" class="bio-reveal">
      <div class="inner bio-card">
        <div class="bio-copy">
          ...
          <p>I’m a founder, operator, and advisor working at the intersection of logistics, technology, people, and execution, often in fast-moving environments where complexity is high and the systems still have to perform.</p>
          ...
          <p>Across all of this, I’ve come to believe that pressure is useful. It exposes weak points, tests alignment, clarifies what needs to change, and reveals whether a system can keep performing when it matters most.</p>
