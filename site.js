  ...
  shell("Bamboo Holdings - Venture Studio", "Home", `
    <section class="inner hero">
      <div>
        ...
        <h1>Focused software from real workflows.</h1>
        <p class="lede">Bamboo builds practical products around specific user behavior, currently focused on resort travel records and two-player golf scoring.</p>
      ...
      <div class="studio-visual" aria-label="Bamboo Holdings venture studio preview">
        <div class="visual-grid">
          ...
          <div class="visual-tile"><strong>Golf scoring</strong><span>Two-player rounds, rivalries, side games, and share cards.</span><i class="metric-line"></i></div>
          <div class="visual-tile"><strong>Specific workflows</strong><span>Focused tools for repeatable personal routines.</span><i class="metric-line"></i></div>
        ...
        <p class="copy">An operator-led product studio: workflow research, careful claims, and a public portfolio focused on practical tools people can actually use.</p>
      </div>
    </section>
    ...
    <section class="inner section tight">
      ...
      ${cards([["Travel records", "Tools for resort travelers who want clean receipts, folios, shared expenses, and trip notes."], ["Golf scoring", "A focused scorecard for two-player rounds, rivalry stats, and friendly side-game math."], ["Specific workflows", "Small, practical products built around clear user behavior rather than broad platform promises."]])}
    </section>
    <section class="band section">
      <div class="inner split">
...
function ventures() {
  shell("Ventures - Bamboo Holdings", "Ventures", `
    ...
    <section class="inner section">
      ...
      ${cards([["App portfolio", "The current public app portfolio focuses on resort travel records and two-player golf scoring."], ["Future venture areas", "Bamboo may explore additional venture areas over time, but no specific future project is being named or announced here."], ["Founder-led discipline", "The priority is workflow depth, careful product building, useful support pages, and honest availability language."]])}
    </section>`);
}
...
function appsPage() {
  shell("Apps - Bamboo Holdings", "Apps", `
    <section class="inner hero narrow">
      ...
      <p class="lede">The Bamboo app portfolio currently focuses on two practical products: TripTracker Pro for resort travel records and Match Card for two-player golf scoring.</p>
    </section>
    <section class="inner section tight">
