    ...
    <section id="bio" class="bio-reveal">
      <div class="inner bio-card">
        <div class="bio-copy">
          ...
          <p>I’m happiest when I’m building, learning, or helping someone think through something that feels stuck. A lot of my work has lived in places where people, technology, logistics, and execution all have to come together, usually with some pressure attached.</p>
          <p>After graduating from Arizona State University in 2007, I co-founded <strong>Dorm Room Movers</strong> and spent <strong>16 years</strong> helping build it into a nationwide, asset-light logistics platform serving more than <strong>300 universities and boarding schools</strong> across <strong>42 states</strong>. Along the way, the company helped more than <strong>100,000 students and families</strong> through a high-trust, time-sensitive service model.</p>
          <p>The business taught me a lot about pressure. Roughly <strong>90% of annual revenue</strong> happened inside a <strong>six-week window</strong>, which meant the systems had to work, the people had to be aligned, and the plan had to survive contact with reality.</p>
          <p>Since exiting Dorm Room Movers in 2023, I’ve been building what comes next through <strong>Bamboo Holdings</strong>, where I advise founders, build software, and explore ideas across AI, automation, logistics, financial systems, and real-world operations. I like problems that are hard enough to be interesting, especially when there’s a chance to build a system, process, or tool that makes things clearer.</p>
          <p>Outside of work, most of my life is built around my <strong>wife and three daughters</strong>. That means gymnastics, art projects, school events, family trips, and whatever new thing the girls are into. Some of my favorite projects start there.</p>
          <p>I’m active in <strong>EO Arizona</strong>, mentor founders through <strong>EO Accelerator</strong>, play golf badly enough to stay humble, and love going to improv with my wife because laughing together still feels like one of the better uses of time.</p>
          <p>I like being around people who inspire me, challenge me, and make me want to keep getting better.</p>
