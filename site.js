    ...
    <section id="bio" class="bio-reveal">
      <div class="inner bio-card">
        <div class="bio-copy">
          ...
          <p>As a founder, operator, and advisor, I work at the intersection of logistics, technology, people, and execution, often in fast-moving environments where complexity is high and the systems still have to perform.</p>
          <p>After graduating from Arizona State University in 2007, I co-founded <strong>Dorm Room Movers</strong> and spent <strong>16 years</strong> scaling it into a nationwide, asset-light logistics platform serving more than <strong>300 universities and boarding schools</strong> across <strong>42 states</strong>. Those institutions included Yale, Carnegie Mellon, UMass Amherst, Choate Rosemary Hall, Berkshire School, and IMG Academy. Along the way, the company helped more than <strong>100,000 students and families</strong> through a high-trust, time-sensitive service model.</p>
          <p>Operating at that scale required more than a strong service model. We built <strong>custom technology and operating systems</strong> to coordinate a distributed network of more than <strong>200 local partners and national van line agents</strong>.</p>
          <p>Roughly <strong>90% of annual revenue</strong> occurred within a <strong>six-week window</strong>. Forecasting had to be accurate, vendors had to perform, schools had to trust us, customers had to be supported, and the technology had to hold. Every year was a live stress test of the business.</p>
          <p>Earlier in my career, I helped build and operate a <strong>250-seat corporate operations and customer service center</strong> in Austin for <strong>iEnergizer</strong>, supporting <strong>Electronic Arts</strong>. That experience gave me an early foundation in enterprise operations, team leadership, and high-volume execution.</p>
          <p>Since exiting Dorm Room Movers in 2023, I have been building what comes next through <strong>Bamboo Holdings</strong>. Today, I advise scaling companies, develop software products, and explore opportunities across AI, automation, logistics, financial technology, and real-world operations. I also remain active in <strong>Entrepreneurs’ Organization Arizona</strong> and mentor founders through <strong>EO Accelerator</strong>.</p>
          <p>Outside of work, I spend as much time as possible with my wife and three daughters.</p>
          <p>Across everything I have built and operated, one belief has remained consistent: pressure is useful. It exposes weak points, tests alignment, clarifies what needs to change, and reveals whether a system can keep performing when it matters most.</p>
