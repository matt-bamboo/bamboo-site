    ...
    <section id="bio" class="bio-reveal">
      <div class="inner bio-card">
        <div class="bio-copy">
          ...
          <p>Since exiting <strong>Dorm Room Movers</strong> in 2023, I’ve spent more time with my wife and three daughters, stayed active in <strong>Entrepreneurs’ Organization (EO) Arizona</strong>, and mentored founders through <strong>EO Accelerator</strong>. Through <strong>Bamboo Holdings</strong>, I advise scaling companies and build my own software products, including <strong>Chalk</strong>, an app that gives gymnastics coaches, athletes, and parents one shared system for tracking progress and staying aligned. It’s the same instinct that built Dorm Room Movers, just pointed at a more focused and personal problem.</p>
          <p>I’m especially interested in where <strong>AI</strong>, <strong>automation</strong>, <strong>logistics</strong>, and <strong>financial technology</strong> start solving real-world operational problems.</p>
